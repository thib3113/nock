...
function overrideClientRequest() {
  ...
  function OverriddenClientRequest(...args) {
    ...
    if (isOn() && interceptors) {
      ...
      if (isOff() || isEnabledForNetConnect(options)) {
        http.ClientRequest.__originalClientRequest.apply(this, arguments)
      } else {
        common.setImmediate(
          function() {
  ...
  http.ClientRequest.__originalClientRequest = originalClientRequest
...
function restoreOverriddenClientRequest() {
  ...
  if (!http.ClientRequest.__originalClientRequest) {
    debug('- ClientRequest was not overridden')
  } else {
    http.ClientRequest = http.ClientRequest.__originalClientRequest
...
function isActive() {
  ...
  return http.ClientRequest.__originalClientRequest !== undefined
}
